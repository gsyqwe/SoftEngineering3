...
<div  id="tanContainer"  style="background-color: #c0e1f2;width: 18%;height:680px;background-color: white;opacity:0.7;float: left;">
    <input type="hidden" id="whichtag" value="0";>
    <div id="tab">
        <ul>
...
<%
    int which=(int)request.getAttribute("whichtag");
%>
...
<div id="tabCon" style="width: 81%;height: 700px; border: 2px solid black;float: right;background-image: url(images/new-task-bg.jpg);">
    <div id="tabCon_0" >
        ...
        <!--搜索框-->
        <form id="searchForm" name="searchForm" action="zhu4.jsp"  method="get" style="border: 2px solid blue">
            ...
            <table style="width:1000px;border:2px solid green;">
                ...
                <tr>
                    <td colspan="5" align="center">
                        ...
                        <a href="javascript:void(0);" class="turnPage" onclick="changeTab(1),turnTopPage()">上一页</a>&nbsp;&nbsp;&nbsp;
                        <a href="javascript:void(0);"  class="turnPage" onclick="changeTab(1),turnBottomPage()">下一页</a>&nbsp;&nbsp;&nbsp;
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div id="tabCon_1"  >
        ...
        %>
        <form>
            <input type="hidden" id="already_pageIndex" value="1">
        </form>
...
<script>
    ...
    var already_page=document.getElementById("already_pageIndex").value;
    ...
    function turnTopPage(){
        if(pageIndex==1){
            ...
            document.getElementById("whichtag").value=1;
