...
<%
    ...
    List<Task> list=taskService.queryTask_AlreadySubmit((String)session.getAttribute("currentuser"));
        ...
        <table style="width:1000px;border:2px solid green;">
            ...
            <tr style="margin-left: 2%">
                ...
                <td class="item lottery-unit lottery-unit-0 draw-btn" style="border:2px solid red ">
                    ...
                    <!----<div><p style="font-size: 10px;margin-left: 40%" >领取</p></div>--->
                    <a href="AlreadySubmitServlet?taskid=<%=list.get((pageIndex-1)*6-1+i).getTaskId()%>">查看</a>&nbsp;&nbsp;&nbsp;
            ...
            <tr style="margin-left: 2%">
                ...
                <td class="item lottery-unit lottery-unit-0 draw-btn" style="border:2px solid red ">
                    ...
                    <!----<div><p style="font-size: 10px;margin-left: 40%" >领取</p></div>--->
                    <a href="AlreadySubmitServlet?taskid=<%=list.get((pageIndex-1)*6-1+4+i).getTaskId()%>">查看</a>&nbsp;&nbsp;&nbsp;
