...
<%
    ...
    if(request.getParameter("pageIndex")!=null) {
        ...
        list=taskService.queryTask_NotSubmit((String)session.getAttribute("currentuser"));
    }
...
<div id="tabCon" style="width: 81%;height: 700px; border: 2px solid black;float: right;background-image: url(images/new-task-bg.jpg);">
    <div id="tabCon_0" >
        ...
        <!--搜索框-->
        <form id="searchForm" name="searchForm" action="zhu2.jsp"  method="get" style="border: 2px solid blue">
        ...
        <div class="draw" id="lottery" style="margin-left: 5%">
            <table style="width:1000px;border:2px solid red;">
                <%
                    int currentsize=0;
    ...
    <!--已提交-->
    <div id="tabCon_1"  >
        <form  action="zhu2.jsp" method="post">
            <input type="hidden" id="already_submit_pageindex" value="1">
        </form>

        <%
            List<Task> list_alreadysubmit=taskService.queryTask_AlreadySubmit((String)session.getAttribute("currentuser"));
            System.out.println("already"+8);
            int already_submit_size=list_alreadysubmit.size();
            int already_lie1=1;
            int already_lie2=2;
            ...
            <table style="width:1000px;border:2px solid green;">
                <tr>
                    ...
                    <td class="item lottery-unit lottery-unit-0 draw-btn" style="border:2px solid red ">
                        ...
                        <div><p style="font-size: 10px;margin-left: 40%">继续完成+<%=array[5]%></p></div>
                    </td>
